...
export const NewChatRoom = (props: Props) => {
  ...
  return (
            <FormControl onSubmit={createChatroom} display="flex" flexDirection="column" gap="1rem">
                <h3 style={{textAlign:'center', fontSize:'1.5rem', fontWeight:'700'}}>Create new chat </h3>
                <Input size="lg" type="text" id="room" onChange={(e) => setRoomName(e.target.value)} placeholder="Type the new chat name here..." />

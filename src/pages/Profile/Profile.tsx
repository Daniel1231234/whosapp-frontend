...
import { Heading, Button, Card, Box, ButtonGroup, Avatar } from "@chakra-ui/react"
...
export default function UserProfile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    try {
      const capitalName = utilService.capitalizeWords(name)
      await updateUserInDB(capitalName, email.toLowerCase())
